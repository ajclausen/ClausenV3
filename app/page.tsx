        ...
        <main id="content" className="px-6 pb-24 lg:w-[55%] lg:py-24 lg:px-12 text-dracula-foreground">
          <div className="max-w-2xl">
              ...
              <div>
                <ol className="group/list">
                  {certifications.map((cert) => (
                    <li key={cert.id} className="mb-12">
                      <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                        <div className="absolute -inset-x-4 -inset-y-4 z-0 hidden rounded-md transition motion-reduce:transition-none lg:-inset-x-6 lg:block lg:group-hover:bg-dracula-current-line/50 lg:group-hover:shadow-[inset_0_1px_0_0_rgba(148,163,184,0.1)] lg:group-hover:drop-shadow-lg"></div>
                        <header className="z-10 mb-2 mt-1 text-xs font-semibold uppercase tracking-wide text-dracula-foreground sm:col-span-2" aria-label={cert.dateEarned}>
                          {cert.dateEarned}
                        </header>
                        <div className="z-10 sm:col-span-6">
                                ...
                                <div>
                                  {cert.verificationUrl ? (
                                    <a
                                      ...
                                      target="_blank"
                                      rel="noreferrer noopener"
                                      aria-label={`${cert.name} certification (opens in a new tab)`}
                                    >
                                      <span>{cert.name}</span>
                                      <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <span className="font-medium leading-tight text-dracula-foreground">{cert.name}</span>
                                  )}
                                </div>
                                <div className="text-dracula-comment text-sm mt-0.5">{cert.issuer}</div>
                              </h3>
                              {cert.verificationUrl && (
                                <div className="mt-2">
                                  <span className="inline-flex items-center text-xs font-medium text-dracula-cyan">
                                    <svg
            ...
            <section id="contact" className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24" aria-label="Contact">
              ...
              <div>
                <div className="group relative pb-1 transition-all">
                  <div className="absolute -inset-x-4 -inset-y-4 z-0 hidden rounded-md transition motion-reduce:transition-none lg:-inset-x-6 lg:block lg:group-hover:bg-dracula-current-line/50 lg:group-hover:shadow-[inset_0_1px_0_0_rgba(148,163,184,0.1)] lg:group-hover:drop-shadow-lg"></div>
                  <div className="relative z-10">
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      {/* Email */}
                      <a
                        href="mailto:andrew@clausen.app"
                        className="relative z-10 group/link flex items-center gap-3 rounded-lg bg-dracula-current-line/10 p-4 transition-all hover:bg-dracula-current-line/20"
                      >
                        <svg
                          className="h-5 w-5 text-dracula-cyan"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                        ...
                        <div>
                          <div className="text-xs font-semibold text-dracula-comment">Email</div>
                          <div className="text-sm font-medium text-dracula-green group-hover/link:text-dracula-pink transition-colors">
                            andrew@clausen.app
                          </div>
                        </div>
                      </a>
                      ...
                      >
                        ...
                        <div>
                          <div className="text-xs font-semibold text-dracula-comment">LinkedIn</div>
                          <div className="text-sm font-medium text-dracula-green group-hover/link:text-dracula-pink transition-colors">
                            Connect on LinkedIn
                          </div>
                        </div>
                      ...
                      >
                        ...
                        <div>
                          <div className="text-xs font-semibold text-dracula-comment">GitHub</div>
                          <div className="text-sm font-medium text-dracula-green group-hover/link:text-dracula-pink transition-colors">
                            View my code
                          </div>
                        </div>
                      ...
                      >
                        ...
                        <div>
                          <div className="text-xs font-semibold text-dracula-comment">Phone</div>
                          <div className="text-sm font-medium text-dracula-green group-hover/link:text-dracula-pink transition-colors">
                            (300) 700-1000
                          </div>
                        </div>
