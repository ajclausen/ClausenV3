  ...
  return (
    <>
      ...
      <div className="lg:flex lg:justify-between">
        ...
        <header className="px-6 py-24 bg-dracula-background lg:bg-transparent lg:sticky lg:top-0 lg:flex lg:h-screen lg:w-[45%] lg:flex-col lg:justify-between lg:py-24 lg:px-12 lg:will-change-transform">
          <div>
